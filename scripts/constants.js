...
const characterData = [{
        ...
        enhancers: ["[mecha pilot suit", "blue body suit", "gloves,]", "black cat d.va", "officer d.va", "shooting star d.va", "[--mecha pilot suit", "--blue body suit", "palanquin d.va", "hanbok]", "academy d.va", "cruiser d.va", ],
        defaultGender: "girl",
    ...
    },
    {
        ...
        enhancers: ["[yellow pants", "grey jacket", "breastplate", "goggles]", "graffiti tracer", "track and field tracer"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[blue pants", "gloves", "glasses", "fur-trimmed coat]", "honeydew mei", "jiangshi mei"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[purple leotard", "headgear", "gloves", "single pant leg]", "cote d'azur widowmaker", "[--purple skin", "colored skin", "talon widowmaker]", "black lily widowmaker", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[multicolored pants", "black jacket", "fingerless gloves]", "slay star sombra", "hat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[blue dress", "pelvic curtain", "headgear", "goggles", "mechanical arm", "thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[white armor", "pantyhose", "knee boots", "mechanical wings]", "witch mercy", "witch hat]", "pink mercy", "[--yellow hair", "devil mercy]", "imp mercy", "winged victory mercy", "[zhuque mercy", "black hair]", "sugar plum fairy mercy", "[life guard mercy", "red swimsuit", "black shorts]", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[glasses", "helmet", "orange robe", "black shorts", "belt pouch]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[grey fur scarf", "grey fur tube top", "grey fur skirt", "grey wrist cuffs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[white cropped shirt", "low tied hair", "suspenders", "black skirt", "detached black sleeves", "red fingerless gloves", "single elbow pad]", "[tifa lockhart (refined dress)", "purple sleeveless dress", "short dress", "neck ribbon", "gold earrings]", "tifa lockhart (shining spirit)", "multicolored bikini", "bikini skirt", "hair flower", "side locks", "hair bun", "official alternate costume]", "tifa lockhart (cowgirl)", "cowboy hat", "cropped leather vest", "short leather skirt", "black gloves", "official alternate costume]", "tifa lockhart (lifeguard)", "low tied hair", "black hat", "bikini under clothes", "fingerless gloves", "see-through shirt", "skirt", "official alternate costume]", "tifa lockhart (sporty dress)", "china dress", "leopard print", "double bun", "pelvic curtain", "tassel hair ornament", "fishnet thighhighs", "official alternate costume]", "tifa lockhart (majestic glamour)", "striped crop top", "denim shorts", "pantylines", "front-tie top", "official alternate costume]", "tifa lockhart (bahamut suit)", "armor", "clawed gauntlets", "dragon wings", "horned headwear", "low tied hair", "shoulder armor", "official alternate costume]", "tifa lockhart (fairy of the holy flame)", "santa hat", "santa costume", "holly hat ornament", "skirt", "fur-trimmed capelet", "fur-trimmed gloves", "fur-trimmed headwear", "fur-trimmed skirt", "white turtleneck sweater", "official alternate costume]", "tifa lockhart (exotic dress)", "black kimono", "black thighhighs", "hair flower", "wide sleeves", "zettai ryouiki", "official alternate costume]", "tifa lockhart (passion mermaid)", "bikini", "bikini skirt", "see-through clothes", "jewelry", "belly chain", "fingerless gloves", "official alternate costume]", "tifa lockhart (loveless dress)", "white sleeveless dress", "crown", "earrings", "princess rosa costume", "official alternate costume]", "tifa lockhart (bunny bustier)", "animal ear headband", "rabbit ears", "rabbit tail", "detached collar", "elbow gloves", "blue bow", "black frilled miniskirt", "fishnet pantyhose", "nontraditional playboy bunny", "official alternate costume]", "tifa lockhart (honey bee inn)", "bee costume", "black hairband", "fake antennae", "fake wings", "fishnet pantyhose", "frills", "sideless leotard", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[pink dress", "braided ponytail", "red cropped jacket", "bangles", "hair bow]", "aerith gainsborough (red dress)", "braided ponytail", "red dress", "flamenco dress", "hair flowers", "official alternate costume]", "aerith gainsborough (pink mermaid)", "frilled bikini", "official alternate costume]", "aerith gainsborough (white floral dress)", "white strapless dress", "dress flower", "official alternate costume]", "aerith gainsborough (prism dress)", "ponytail", "blue hair bow", "white dress", "dress flower", "gold trim", "official alternate costume]", "aerith gainsborough (sunny robe)", "straw hat", "pink bikini", "white lace swimsuit cover-up]", "aerith gainsborough (fairy of snowfall)", "white dress", "white hat", "white coat", "winter clothes", "thigh strap", "fur trim", "cable knit", "official alternate costume]", "aerith gainsborough (bahamut robe)", "armor", "single shoulder pad", "pantyhose", "headdress", "long dress", "official alternate costume]", "aerith gainsborough (floral delight)", "single braid", "hair flower", "pink crop top", "floral pink sarong", "short sleeves", "midriff", "official alternate costume]", "aerith gainsborough (citric dress)", "food themed earrings", "half updo", "green ribbon", "strapless dress", "see-through clothes", "official alternate costume]", "aerith gainsborough (loveless dress)", "princess rosa dress", "white dress", "crown", "single braid", "official alternate costume]", "aerith gainsborough (honey bee inn)", "bee costume", "fake antennae", "fake wings", "fishnet pantyhose", "sideless leotard", "fur collar", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[headband", "green shirt", "single shoulder pad", "white shorts]", "yuffie kisaragi (summer orange)", "orange floral bikini top", "white shorts", "orange hairband", "official alternate costume]", "moogle (cosplay)", "brown hooded cloak", "hood up", "official alternate costume]", "yuffie kisaragi (summer moogle)", "orange o-ring bikini top", "white shorts", "orange bikini straps", "thigh strap", "goggles on head", "single elbow pad", "official alternate costume]", "yuffie kisaragi (bahamut mantle)", "armor", "horned hood", "thighhighs", "fake dragon tail", "purple leotard", "black shorts", "fingerless gloves", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[black shirt", "black pants", "single shoulder pad", "gauntlets]", "cloud strife (blue dress)", "blue dress", "hair bow", "fishnet sleeves", "puffy sleeves", "twin braids", "official alternate costume]", "cloud strife (bahamut garb)", "armor", "high collar", "single wing", "gauntlets", "see-through shirt", "official alternate costume]", "cloud strife (ball gown)", "purple dress", "tiara", "ribbon choker", "official alternate costume]", "cloud strife (maritime sailor)", "black shirt", "black pants", "sailor collar", "single elbow pad", "official alternate costume]", "cloud strife (wild surf)", "black swim trunks", "suspenders hanging", "official alternate costume]", "cloud strife (alphreid costume)", "blue cloak", "gloves", "leather armor", "official alternate costume]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[long blue sweater", "black shorts", "blue skirt", "blue arm warmers]", "short white dress", "halter dress", "crossed straps", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[yellow zipper dress", "knee boots", "necklace]", "seed uniform (ff8)", "military uniform", "yellow ascot", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[orange shirt", "orange skirt", "zipper", "detached sleeves", "high collar", "gloves]", "seed uniform (ff8)", "military outfit", "red necktie", "grey skirt", "grey jacket", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[long hair", "orange overalls", "white shirt", "leg strap", "low tied hair", "red gloves]", "long hair", "low tied hair", "white strapless dress", "elbow gloves", "hair flower", "headdress", "leaf print", "official alternate costume]", "short hair", "bob cut", "orange overalls", "white shirt", "wide sleeves]", "short hair", "bob cut", "white hooded robe", "white mage (final fantasy)", "orange overalls", "wide sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[bra peek", "long blue skirt", "hair ornament", "japanese clothes", "nontraditional miko", "obi", "wide sleeves", "detached sleeves]", "white crop top", "plunging neckline", "pink hood", "hood down", "blue showgirl skirt", "black short shorts", "yellow armbands", "wrist band", "knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[brown shirt", "green shorts", "belt", "gloves", "detached sleeves", "goggles around neck", "thigh strap", "knee boots]", "blue bandana", "yellow bikini top", "brown skirt", "white detached sleeves", "bikini straps", "gradient scarf]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[fur-trimmed black dress", "off-shoulder dress", "multiple belts", "multiple necklaces", "thighhighs]", "moogle", "stuffed animal", "fur-trimmed black dress", "off-shoulder dress", "multiple belts", "multiple necklaces", "thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[fingerless gloves", "skirt", "white jacket", "high collar", "red cape", "thigh strap]", "armor", "breastplate", "shoulder armor", "greaves", "arm guards", "leotard", "feather skirt]", "asymmetrical clothes", "armor", "silver breastplate", "silver shoulder armor", "greaves", "gauntlets", "white feather skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[red plaid miniskirt", "black thighhighs", "see-through clothes", "white sleeveless shirt", "sleeveless jacket", "white jacket", "high collar", "white armband]", "white dress", "red thighhighs", "zettai ryouiki", "choker", "gloves", "detached sleeves", "belt pouch]", "pink bikinitop", "pink shorts", "yellow bow", "frilled thigh band", "pink bikini strap", "flowers]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[blue cross-laced pants", "white coat", "wide sleeves]", "white coat", "high collar", "shoulder armor", "pantyhose", "thigh boots]", "feather-trimmed black dress", "cross-laced footwear", "thigh boots", "wide sleeves", "fingerless gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[red dress", "cropped jacket", "fur-trimmed jacket", "thigh boots", "utility belt]", "white shorts", "white shirt", "red jacket", "thigh boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[red shorts", "red shirt", "two-tone jacket", "fingerless gloves", "blue belt", "belt chain]", "black puffy pants", "black jacket", "black shirt", "fingerless gloves", "necklace]", "black puffy pants", "black jacket", "red shirt", "fingerless gloves", "necklace", "multiple belts", "yellow straps]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[purple shorts", "white camisole", "black tanktop", "choker", "purple belt]", "two-tone dress", "white tank top", "belt]", "blue plaid skirt", "sleeveless white shirt", "knee socks", "blue necktie]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["black coat (kingdom hearts)", "[grey pleated skirt", "sleeveless black shirt", "black belt", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    },
    {
        ...
        enhancers: ["[blue pants", "black zipper vest", "white and yellow jacket", "high collar", "open jacket]", "blue pants", "puffy pants", "two-tone shirt", "yellow shirt", "black shirt", "sleeveless shirt", "chest strap]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games",
    ...
    },
    {
        ...
        enhancers: ["[brown pants", "red coat", "chest strap]", "black pants", "red coat", "black shirt", "fingerless gloves]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[red headband", "white bulletproof vest", "green shirt", "green pants", "s.t.a.r.s. uniform]", "red choker", "white bulletproof vest", "green shirt", "green pants", "s.t.a.r.s. uniform]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[jeans", "red jacket", "white shirt", "belt", "thigh holster]", "[denim shorts", "red vest", "black shirt", "belt pouch", "cowboy boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black pants, blue camisole, white shirt, thigh holster, belt, holster]", "black skirt, blue tube top, sweater around waist, knee boots]", "blue pants, blue shirt, blue hat, s.t.a.r.s. uniform, shoulder armor, straps]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[china dress", "red dress", "halterneck", "choker", "thigh holster]", "black pants", "red sweater dress", "ribbed sweater", "holster]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[purple tank top", "green pants", "black hat", "fingerless gloves]", "black hat", "grey police uniform", "sheriff badge", "belt]", "bulletproof vest", "police uniform", "elbow pad", "fingerless gloves]", "brown jacket", "fur-trimmed jacket", "black pants", "thigh holster", "blue shirt]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[orange cableknit shirt", "orange jacket", "green skirt", "pantyhose", "knee boots", "red kerchief]", "orange cableknit shirt", "green skirt", "pantyhose", "knee boots", "red kerchief]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[white shirt", "blue scarf", "capri pants", "belt", "holster", "shoulder holster]", "white coat", "fur-trimmed coat", "white shirt", "blue scarf", "black leggings", "belt", "holster", "shoulder holster]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[green highleg leotard", "red beret", "red fingerless gloves", "pantyhose", "camouflage print]", "black capri pants", "black crop top", "blue jacket", "black fingerless gloves", "red wrist cuffs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[blue dress, pelvic curtain, puffy short sleeves, spiked wrist cuffs, pantyhose]", "blue bodysuit, blue cropped vest, single wrist cuff]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[purple hooded cape", "hood up", "white pants", "white crop top", "purple skirt]", "armor", "breastplate", "cloak", "shoulder armor", "white dress]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[the legend of zelda: breath of the wild, two-tone shirt, black pants, belt]", "the legend of zelda: tears of the kingdom, two-tone shirt, black pants, belt, brown cloak]", "the legend of zelda: twilight princess, white dress, pink shirt, detached sleeves, shoulder armor, hair decoration]", "the legend of zelda: ocarina of time, pink dress, purple vest, shoulder armor, elbow gloves]", "the legend of zelda: skyward sword, pink dress, belt, white capelet, green wrist cuffs]", "the legend of zelda: a link to the past, white dress, pink tunic, white cape, necklace, bracers]", "the legend of zelda: echoes of wisdom, white dress, pink dress, grey scarf]", "the legend of zelda: spirit tracks, toon zelda,sleeveless pink skirt, pink shirt, pink capelet, white elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[red bodysuit", "bodysuit under clothes", "sleeveless shirt", "pantyhose", "red trim", "brown coat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[soulcalibur vi", "shoulder armor", "purple straps", "impossible clothes", "detached sleeves", "elbow gloves", "purple bikini armor]", "soulcalibur v", "single gauntlet", "claw gauntlet", "single shoulder pad", "asymmetric clothes", "black leotard", "cross laced clothes", "garter straps", "purple highleg leotard", "purple thighhighs", "purple gloves", "high collar", "wrist cuff", "purple sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[soulcalibur vi", "orange dress", "blue scarf", "arm bands", "detached collar", "short hair", "pantyhose]", "soulcalibur iv", "blue dress", "brown hair bow", "thigh boots", "pink necktie", "pink ribbons", "white elbow gloves", "shoulder armor]", "soulcalibur ii", "white headband", "sleeveless dress", "two-tone dress", "pink necktie", "pantyhose", "belt", "white elbow gloves", "sailor collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[soulcalibur vi", "armored dress", "thigh boots", "silver laurel crown", "multicolored dress]", "soulcalibur iv", "greco-roman clothes", "white dress", "see-through clothes", "blue belt", "vambraces]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[ninja", "sleeveless red bodysuit", "skin tight", "shoulder armor", "fingerless gloves", "knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[china dress", "blue thighhighs", "detached sleeves", "headband]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[gothic lolita", "lolita hairband", "cross-laced clothes", "black dress", "black fishnet gloves", "purple flower", "red shawl", "fishnet thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[bandeau", "capri pants", "see-through clothes", "sleeveless green vest", "hat", "pink sash", "white panties", "white panty strap", "fingerless gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white dress", "white capelet", "brown corset", "hair ornament", "brown thighhighs", "folded top thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[fingerless gloves", "crop top", "breast curtain", "pelvic curtain", "wide short sleeves", "vambraces]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[purple gloves", "fingerless elbow gloves", "short hair", "green shirt", "black pants", "black jacket", "torn clothes", "green feathers", "feather trim", "choker]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "cross-laced cutout", "detached sleeves", "brown thighhighs", "garter straps", "black hooded cape", "hood up", "claw (weapon)]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["star guardian lux", "light elementalist lux", "dark elementalist lux", "[--blonde hair", "battle academia lux", "red hair", "pony tail]", "--blonde hair", "lunar empress lux", "blue hair]", "dark cosmic lux", "space groove lux"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["arcade sona", "[dj sona", "multicolor bodysuit", "visor", "helmet", "multicolor hair", "purple hair]", "sweetheart sona", "[--blue hair", "star guardian sona", "glasses", "green hair]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[kitty cat katarina", "fake animal ears", "cat tail]", "battle academia katarina", "[--red hair", "slay belle katarina", "blonde hair", "santa dress", "no hood]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["battle bunny riven", "spirit blossom riven", "[--white hair", "arcade riven", "green hair", "blue bandanna", "helmet visor]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[crown", "silver hair ornament]", "divine sword irelia", "[--black hair", "frost blade irelia", "blue hair", "short hair]", "--black hair", "mythmaker irelia", "hair bun", "white hair]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["star guardian syndra", "spirit blossom syndra", "[--white hair", "withered rose syndra", "purple hair]", "--white hair", "snow day syndra", "fur coat", "blonde hair", "earmuffs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[purple dress", "star tattoo]", "--pink hair", "star guardian seraphine", "blonde hair", "magical girl]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[--blonde hair", "armor", "boobplate", "glowing eyes", "feathered wings", "white hair", "multiple wings]", "helmet", "angel wings", "armor]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[--blue eyes", "black blindfold", "black dress", "black hairband", "feather-trimmed sleeves", "black thighhighs", "cleavage cutout", "puffy sleeves]", "black dress", "black hairband", "feather-trimmed sleeves", "black thighhighs", "cleavage cutout", "puffy sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shorts", "black elbow gloves", "black shirt", "robot joints]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white dress", "feather-trimmed dress", "cleavage cutout", "white thighhighs", "leotard under dress", "two-sided dress", "white blindfold]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[leather armor", "chainmail", "brown pants", "vambraces", "pelvic curtain", "knee boots", "blue skirt]", "black shirt", "plunging neckline", "black pants]", "--black hair", "white hair", "armor", "boobplate", "full armor]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[leather armor", "clothing cutout]", "black pants", "clothing cutout", "black tube top", "single bare shoulder", "leather strap", "o-ring]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[leather armor", "brown pants", "multicolored shirt]", "white frilled shirt", "brown pants", "cross-laced top]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[armor", "full armor", "paundrons", "short sleeves", "hip armor", "thigh straps]", "black capri pants", "belt", "bikini top only", "o-ring bikini]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[armor", "full armor", "pauldrons", "gauntlets", "greaves]", "black pants", "black vest", "cross-laced top", "shoulder pads]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black bodysuit", "white jacket", "fur-trimmed jacket", "choker", "single elbow glove", "single glove", "leggings]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[nun", "bare shoulders", "short hair", "veil", "hat", "white tanktop leotard", "black skirt", "belts", "white elbow gloves", "claw ring", "fishnet pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[brown short shorts", "tank top", "thigh holster]", "sleeveless grey shirt", "brown pants", "fingerless gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[cropped blue jacket", "blue skirt", "white corset", "necklace]", "ponytail", "high-waist skirt", "blue skirt", "sleeve cuffs", "white shirt", "black ascot", "knee boots]", "black skirt", "pencil skirt", "long skirt", "white shirt", "red bolo tie", "brooch", "sleeve cuffs", "fishnet pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[armor", "black bodysuit", "boobplate", "shoulder armor", "pelvic curtain", "red ribbon", "vambraces]", "wedding dress", "bridal veil", "tiara", "elbow gloves", "frills]", "maid", "long sleeves", "detached collar", "wrist cuffs", "maid apron", "maid headdress", "black thighhighs]", "pink dress", "frilled dress", "pajamas", "short puffy sleeves]", "towel", "[megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue dress", "thigh boots", "detached sleeves", "blue bow", "blue skirt", "white thighhighs]", "black highleg leotard", "black elbow gloves", "wrist cuffs", "animal ear hairband", "rabbit ears", "rabbit tail", "detached collar", "nontraditional playboy bunny", "fishnet pantyhose]", "towel", "[megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "darkness (konosuba) (cosplay)", "armor]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[red dress", "belt", "witch hat", "single black thighhigh", "bandaged leg", "fingerless gloves]", "red eyepatch", "red dress", "belt", "witch hat", "single black thighhigh", "bandaged leg", "fingerless gloves]", "red prison magic school uniform", "witch hat", "fingerless gloves", "pink dress", "black cloak", "two-sided fabric", "kono subarashii sekai ni bakuen wo!]", "towel", "[darkness (konosuba) (cosplay)", "armor]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black dress", "pink skirt", "red thighhighs", "pink necktie", "hair decoration", "belt]", "red prison magic school uniform", "pink dress", "black cloak", "two-sided fabric", "black thighhighs", "black pantyhose", "kono subarashii sekai ni bakuen wo!]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[purple dress", "purple coak", "bat brooch", "wide sleeves]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", "towel"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black pants", "white shirt", "high collar", "green cape]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "aqua (konosuba) (cosplay)", "towel", "green track suit"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white dress", "purple dress", "blue bow", "necklace", "food-themed hair ornament]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", "towel"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[brown skirt", "white shirt", "suspenders", "two-sided cape]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue shorts", "blue scarf", "green cropped jacket", "black tube top", "detached sleeves", "gloves", "white thighhighs]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[long white dress", "purple habit", "purple shirt", "cross-laced top", "white leggings]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white shirt", "detached sleeves", "detached collar", "red bow", "denim shorts]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black gloves", "black thighhighs", "garter straps", "red panties", "o-ring top", "black babydoll]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[red prison magic school uniform", "pink dress", "black cloak", "two-sided fabric", "black thighhighs", "zettai ryouiki", "kono subarashii sekai ni bakuen wo!]", "darkness (konosuba) (cosplay)", "armor]", "megumin (cosplay)", "witch hat]", "satou kazuma (cosplay)", "green cape]", "satou kazuma (cosplay)", "green track suit]", "aqua (konosuba) (cosplay)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[black dress", "zipper", "high collar", "black thighhighs]", "purple skirt", "purple vest", "cross-laced top", "purple hat", "armband", "frills]", "white hat", "white coat", "fur-trimmed coat]", "purple hat", "purple jacket", "white shirt", "purple pants]", "white hat", "yellow tank top", "purple capri pants", "orange belt]", "purple shirt", "black skirt]", "blue zipper vest", "orange sarong]", "eyewear on head", "pink shirt", "high collar", "plunging neckline]", "white sleeveless kimono", "floral print kimono", "black haori", "obi", "side slit]", "yellow shirt", "eyewear on head", "yellow plaid skirt", "wide sleeves", "v-neck]", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white shirt", "striped shirt", "orange skirt]", "pink shirt", "orange skirt]", "green tank top", "polka dot shirt", "blue shorts]", "white coat", "fur-trimmed coat", "white vest", "grey skirt", "fur-trimmed skirt]", "red dress", "side slit", "arm tattoo", "fur scarf]", "blue bikini top", "yellow skirt", "brown belt]", "white tank top", "striped shirt", "yellow skirt]", "camouflage bikini", "bikini top only", "brown pants", "yellow belt]", "dark blue shirt", "short sleeves", "blue necktie", "white skirt", "rings on skirt]", "bikini top only", "jeans", "black belt", "bracelet]", "pink tanktop", "striped shorts]", "white halter top", "red skirt", "frills]", "red dress", "white shirt", "puffy short sleeves", "pink back bow]", "short white dress", "long sleeves", "brown belt]", "blue kimono", "orange bow", "blue hair ribbon]", "sleeveless white leotard", "high collar", "pink knee boots", "headphones", "science fiction]", "brown fur vest", "black fur-trimmed cape", "brown miniskirt", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[red sarong", "red crop top", "epaulettes", "plunging neckline", "white cape]", "sleeveless purple dress", "side slit", "skull print", "collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[glasses", "hair bun", "green hairband", "yellow jacket", "high collar jacket", "black skirt]", "glasses", "black dress", "plunging neckline", "fishnet thighhighs", "garter straps", "black gloves", "high collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white dress", "black ribbon", "headphones", "pink jacket", "puffy sleeves", "hood down]", "sleeveless white dress", "black ribbon", "single sleeve", "wings", "two-tone wings", "headphones]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[amestris military uniform", "blue jacket", "blue pants]", "black turtleneck", "long skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black pleated skirt", "white tanktop]", "black pleated skirt", "black cropped jacket", "white tanktop]", "red bandana", "purple overalls", "clothes around waist", "black tube top", "brown gloves]", "green bandana", "grey overalls", "clothes around waist", "black tube top]", "grey overalls", "clothes around waist", "black and white crop top]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[armor", "full armor", "shoulder spikes", "arm tattoo", "red eyes]", "blonde hair", "short hair", "brown eyes", "black suit", "black pants", "black vest", "red necktie", "white shirt]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[amestris military uniform", "blue jacket", "blue pants", "black coat", "coat on shoulders", "white gloves]", "amestris military uniform", "blue jacket", "blue pants", "white gloves]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[raizen high school uniform", "black jacket", "white shirt", "blue skirt", "red bow]", "frilled red dress", "red ribbon", "headdress", "elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[frilled blue dress", "hair bows", "puffy sleeves", "ribbon]", "pink dress", "greaves", "black gloves]", "red dress", "pelvic curtain", "elbow gloves", "arm guards", "thigh boots", "thigh straps]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white sun dress", "short dress", "pink trim", "puffy short sleeves", "sun hat]", "white dress", "green coat", "animal hood", "rabbit ears]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[orange crop top", "off shoulder", "suspenders", "black bloomers", "ba wings", "striped thighhighs", "uneven legwear", "witch hat]", "kyouno natsumi (adult)", "bodystocking", "bodysuit", "black skirt", "halter top", "see-through clothes", "witch hat", "black capelet", "high collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[frilled purple dress", "pink shirt", "yellow frills]", "yellow skirt", "white elbow gloves", "layered skirt", "see-through clothes", "white pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[raizen high school uniform", "blue pleated skirt", "black jacket]", "white dress", "white bow", "white elbow gloves", "gold crown", "gold trim", "over-kneehighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[glasses", "purple headband", "red shirt", "grey shorts", "thigh pouch", "detached sleeves]", "glasses", "black choker", "black coat", "two-sided coat", "single thighhigh", "fishnet thighhigh", "thigh boots", "red belt", "strapless black leotard", "leotard under clothes", "black skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[black suit", "suit jacket", "white shirt", "black necktie", "black pants]", "white panties", "blue tanktop]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black capri pants", "white shirt", "black necktie", "blue coat]", "red longsleeve shirt", "blue shorts]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white scarf", "black tube top", "white chaps", "black panties", "belt", "detached sleeves]", "animal ears", "lion ears", "animal hands", "lion tail", "white scarf", "black tube top", "white chaps", "black panties", "belt", "detached sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[armored dress", "blue skirt", "pauldrons", "gauntlets", "knee boots]", "chest sarashi", "red pants", "ponytail", "white straps", "official alternate costume]", "japanese clothes", "purple kimono", "pelvic curtain", "pink thighhighs", "bandaged arms", "official alternate costume]", "red highleg leotard", "black pantyhose", "nontraditional playboy bunny", "fake animal ears", "rabbit ears", "wrist cuffs", "detached collar]", "maid", "red vest", "white shirt", "red skirt", "white thighhighs", "maid headdress", "white gloves", "puffy short sleeves", "waist apron", "twintails", "fairy tail logo", "arm tattoo]", "ponytail", "black bikini", "side-tie bikini bottom]", "towel", "[black latex bodysuit", "hair flower]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[side ponytail", "blue ribbon", "two-tone sleeveless shirt", "collar", "blue skirt", "brown belt", "knee boots]", "twintails", "black skirt", "two-tone tube top", "blue vest", "detached sleeves", "puffy sleeves", "thighhighs", "white belt]", "high ponytail", "single detached sleeve", "black sleeve", "blue sleeveless shirt", "collar", "white skirt", "belt pouch", "thigh boots]", "double bun", "asymmetrical legwear", "cow print bikini", "bikini top only", "detached sleeves", "cow print sleeves", "fingerless gloves", "black pants", "belt", "bell collar", "official alternate costume]", "fake animal ears", "rabbit ears", "pink leotard", "black pantyhose", "detached collar", "wrist cuffs", "official alternate costume]", "fake animal ears", "rabbit ears", "red leotard", "white trim", "pantyhose", "detached collar", "wrist cuffs", "official alternate costume]", "side ponytail", "purple ribbon", "purple tube top", "white winter coat", "fur-trimmed coat", "black skirt", "white belt", "pantyhose", "knee boots", "cross-laced footwear", "official alternate costume]", "updo", "short black dress", "v-neck", "white trim", "frills", "white bow", "white belt", "belt buckle", "heart necklace", "official alternate costume]", "low twintails", "sleeveless blue shirt", "pink neck bow", "brooch", "blue skirt", "blue thighhighs", "frilled legwear", "frilled wrist cuffs", "official alternate costume]", "white bikini", "side-tie bikini bottom", "halterneck", "pink floral print", "print bikini", "official alternate costume]", "long twintails", "pink bikini", "bikini top only", "short pelvic curtain", "gold thighlet", "print bikini", "floral print", "choker", "hair ornament", "official alternate costume]", "twintails", "maid", "maid headress", "black vest", "white shirt", "puffy short sleeves", "black skirt", "waist apron", "frilled wrist cuffs", "lace-trimmed thighhighs", "white thighhighs", "black neck ribbon", "official alternate costume]", "fake animal ears", "cat ears", "cat tail", "black short shorts", "black tube top", "cross-laced clothes", "red belt", "pink trim", "neck bell", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[twintails", "black pleated skirt", "red jacket", "white shirt", "yellow bow", "black thighhighs]", "twintails", "green sleeveless dress", "halterneck", "arm bands]", "twintails", "black latex bodysuit", "metal collar", "official alternate costume]", "twintails", "green plaid bikini", "halterneck]", "ponytail", "yellow hair bow", "green bikini", "bikini skirt", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue skirt", "green shirt", "blue jacket", "fur-trimmed jacket", "blue hat", "thigh boots", "waist sash]", "blue dress", "blue hat", "hat flower", "blue capelet", "fur trim", "thigh boots]", "purple bikini", "polka dot", "white frilled trim", "front-tie top", "bikini skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[sleeveless red dress", "pink shirt collar", "detached pink sleeves", "puffy sleeves", "kneehighs", "white ribbon]", "animal girl", "cat girl", "white cat ears", "animal feet", "cat paws", "cat tail", "white bikini", "white tiger print", "white fairy tail logo on thigh]", "purple bikini", "frilled bikini top", "halter neck", "side-tie bikini bottom", "fairy tail logo on thigh]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[brown pants", "black frilled bikini", "strapless bikini", "bikini top only]", "brown pants", "teal bikini", "bikini top only", "arm bands", "multiple bracelets]", "striped bikini", "halterneck", "red bikini", "green stripes", "arm bands", "multiple bracelets]", "white shirt", "center frills", "pink skirt", "puffy sleeves", "pink ribbon", "yellow hat", "hat flower", "rose]", "black latex bodysuit", "[checkered bikini", "blue and white bikini", "bikini top only", "brown capri pants", "red floral print skirt", "side slit", "arm bands", "multiple bracelets]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black turtleneck", "long white skirt]", "long black dress", "frilled dress", "white frills", "off shoulder", "neck ribbon]", "long red dress", "pink bow on chest", "pink bow on hip", "necklace", "bracelet]", "teal bikini", "o-ring bikini", "o-ring bottom", "o-ring top", "white trim]", "black leotard", "collared leotard", "sleeveless leotard", "thighhigh boots", "zipper]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[yellow hairband", "flower ornament", "orange dress", "detached sleeves", "halterneck]", "yellow hairband", "striped bikini", "red bikini", "white bikini", "halterneck]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[pink dress", "white capelet", "pink ribbon", "wing hair ornament]", "striped bikini", "blue bikini", "yellow bikini", "halterneck]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[kuoh academy school uniform", "pink pleated skirt", "white shirt", "black corset", "black ribbon", "kneehighs]", "kuoh academy school uniform", "pink pleated skirt", "white shirt", "black corset", "black capelet", "black ribbon", "kneehighs]", "black bodysuit", "black shoulder armor", "black thighhighs", "zettai ryouiki", "short sleeves", "fingerless elbow gloves", "black gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon", "black capelet]", "kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[grey pants suit", "grey pants", "grey suit jacket", "white shirt]", "armored dress", "armor", "boobplate", "detached sleeves", "gauntlets", "faulds", "gold trim", "black leotard", "black thighhighs", "fingerless gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon", "black capelet]", "kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon]", "animal girl", "cat ears", "cat tail", "multiple tails", "kuoh academy school uniform", "pink skirt", "white shirt", "black corset", "back ribbon]", "animal girl", "cat ears", "cat tail", "multiple tails", "frilled kimono", "white kimono", "kimono skirt", "black obi", "blue pleated skirt", "medium breasts", "frilled thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon", "black capelet]", "kuoh academy school uniform", "pink skirt", "black corset", "white shirt", "black ribbon]", "sleeveless black bodysuit", "black elbow gloves", "thighhighs", "zettai ryouiki", "underbust strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[pink kimono", "pink ribbon", "checkered sash", "black coat", "bamboo gag]", "demon girl", "single demon horn", "cracked skin", "pink kimono", "pink ribbon", "checkered sash", "black coat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[--white hair", "--gradient hair", "black hair", "brown kimono", "revealing clothes", "multicolored obi", "stirrup thighhighs]", "brown kimono", "revealing clothes", "multicolored obi", "stirrup thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[demon slayer uniform", "black jacket", "blue skirt]", "demon slayer uniform", "black jacket", "blue skirt", "white jacket", "white skirt", "pants under skirt", "short over long sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[fujimi high school uniform", "green skirt", "white shirt", "green sailor collar", "black bow", "kneehighs]", "white apron", "ponytail", "long apron", "nearly naked apron", "black thong", "side-tie panties]", "fujimi high school uniform", "white shirt", "green sailor collar", "black bow", "purple thighhighs", "black skirt", "single side slit", "side-tie panties", "armored boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[fujimi high school uniform", "green skirt", "white shirt", "green sailor collar", "black bow", "black thighhighs]", "pink camisole", "plain white panties]", "plaid green skirt", "white shirt", "green sailor collar", "black bow", "knee pads]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[fujimi high school uniform", "green skirt", "white shirt", "green sailor collar", "black bow", "white knee socks]", "black short shorts", "blue tank top]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[brown pencil skirt", "torn skirt", "single side slit", "white collared shirt", "red ribbon]", "long white shirt", "no panties]", "blue turtleneck sweater", "white pants", "capri pants]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white dress", "frilled dress", "hip vent", "black wings", "low wings", "detached collar", "white elbow gloves]", "black armor", "full armor", "boobplate", "greaves", "clawed gauntlets", "leg armor]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white headband", "red sweater dress", "off shoulder", "black pantyhose", "gold earrings]", "gold headband", "gold rose", "hair flower", "black halter dress", "black choker", "off shoulder", "fingerless gloves", "two-sided fabric", "thigh boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[eden academy school uniform", "black dress", "white thighhighs]", "red dress", "white collar", "yellow jacket]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[green crop top", "blue capri pants]", "black turtleneck", "crop top", "black gloves", "green cargo pants", "utility belt]", "purple turtleneck", "short sleeves", "grey gloves", "black pants", "thigh holster]", "cheerleader", "purple sleeveless shirt", "crop top", "purple skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[blue eyes", "blonde hair", "medium hair", "superhero costume", "black bodysuit", "multicolored bodysuit", "hood down", "black hairband]", "superhero costume", "white mask", "black bodysuit", "multicolored bodysuit]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[superhero costume", "red bodysuit", "yellow gloves", "yellow knee boots", "red mask]", "green eyes", "no mask", "superhero costume", "red bodysuit", "yellow gloves", "yellow knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "red armor", "power armor", "blue eyes", "glasses", "brown hair", "short hair", "no helmet]", "superhero costume", "red armor", "power armor]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "white corset", "cross-laced top", "white panties", "white cape", "white thigh boots", "fur-trimmed cape", "white elbow gloves]", "superhero costume", "white off-shoulder shirt", "crop top", "white pants", "white cape", "white elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[phoenix (x-men)", "superhero costume", "green bodysuit", "yellow elbow gloves", "headband", "shoulder pads]", "superhero costume", "black headband", "black bodysuit", "yellow bodysuit", "two-tone bodysuit", "black shoulder pads", "fingerless elbow gloves", "black gloves]", "superhero costume", "yellow bodysuit", "blue highleg leotard", "bodysuit under clothes", "blue bracers", "blue headdress", "red forehead jewel", "blue belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[superhero costume", "yellow coat", "black shirt", "pink shirt", "two-tone shirt", "eyewear on head", "black fingerless gloves", "denim shorts", "black belt", "black thighhighs", "knee boots]", "superhero costume", "black bodysuit", "skintight", "pink choker", "pink belt", "yellow coat", "eyewear on head]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "blue shirt", "red skirt", "red cape", "superman logo]", "superhero costume", "blue crop top", "blue miniskirt", "red cape", "superman logo", "long sleeves", "red knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "black bodysuit", "yellow gloves", "blue capelet", "yellow capelet", "two-sided capelet", "yellow belt", "black mask", "batman symbol]", "superhero costume", "grey bodysuit", "blue gloves", "blue capelet", "black capelet", "two-sided capelet", "yellow belt", "blue mask", "batman symbol]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[superhero costume", "blue highleg leotard", "strapless leotard", "star print", "bracers", "gold headband]", "superhero costume", "red highleg leotard", "strapless leotard", "star print", "blue skirt", "bracers", "gold headband]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "black domino mask", "green bodysuit", "red shirt", "utility belt", "green gloves]", "superhero costume", "black domino mask", "red bodysuit", "red pants", "black male underwear", "underwear over clothes", "utility belt", "black gloves]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "purple crop top", "silver collar", "silver bracers", "purple skirt", "silver belt", "purple knee boots]", "superhero costume", "starfire (1980 costume)", "impossible clothes", "clothing cutouts", "plunging neckline", "purple slingshot swimsuit", "revealing clothes", "purple collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[superhero costume", "purple suit", "pinstripe suit pants", "green vest", "orange shirt", "green ascot", "white gloves]", "superhero costume", "purple suit", "yellow shirt", "blue ascot", "white gloves]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[harley quinn (classic)", "black bodysuit", "red bodysuit", "two-tone bodysuit", "frilled collar", "jester cap", "mask]", "harley quinn (suicide squad)", "blonde hair", "long hair", "twintails", "gradient hair", "multicolored hair", "fishnet pantyhose", "white crop top", "mutlicolored short shorts", "single fingerless glove]", "harley quinn (2021 outfit)", "blonde hair", "long hair", "twintails", "gradient hair", "multicolored hair", "green hair", "pink hair", "black pants", "red pants", "two-tone pants", "black camisole", "red camisole", "two-two camisole", "red gloves", "red choker]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[superhero costume", "grey bodysuit", "black elbow gloves", "mask", "fake animal ears", "yellow belt]", "superhero costume", "black latex bodysuit", "fake animal ears", "goggles on head", "black elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[superhero costume", "colored skin", "green skin", "tattoo", "green lips", "monster girl", "red collared shirt", "revealing clothes", "green panties]", "superhero costume", "strapless leotard", "sleeveless leotard", "leaf highleg leotard", "leaf hair ornament]", "superhero costume", "strapless leotard", "sleeveless leotard", "green leotard", "green pantyhose", "green elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[ponytail", "blue hair bow", "white shirt", "blue pinaforedress", "white waist apron]", "high ponytail", "yellow sleeveless dress", "off shoulder", "yellow elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[off shoulder", "aqua dress", "blue cape]", "black shirt", "strapless blue dress", "purple cape", "pleated skirt", "long dress]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[braided bun", "frilled green dress", "pleated skirt", "black corset", "necklace]", "twin braids", "pink cape", "teal shirt", "blue skirt", "black corset", "knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue dress", "hair bun", "makeup", "detached sleeves", "corset", "white elbow gloves]", "white bandanna", "long brown dress", "teal shirt", "long sleeves", "black vest", "white waist apron]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[purple shirt", "black pants", "wide sleeves", "red sash]", "black skirt", "blue shirt", "black fest", "fur trim", "red sash]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[shuujin academy school uniform", "striped skirt", "pleated skirt", "blue jacket", "white shirt]", "panther (persona 5)", "red bodysuit]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shorts", "white shirt", "green jacket", "fur-trimmed jacket", "headphones]", "oracle (persona 5)", "black bodysuit]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[shuujin academy school uniform", "black vest", "plaid skirt]", "queen (persona 5)", "bike suit]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[pink turtleneck sweater", "plaid skirt", "white pantyhose]", "noir (persona 5)", "eye mask", "hat", "white ascot", "pink shirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[shuujin academy school uniform", "black jacket", "plaid skirt]", "violet (persona 5)", "black leotard", "leather jacket]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[shuujin academy school uniform", "black jacket", "plaid pants]", "joker (persona 5)", "long black coat", "eye mask]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[shuujin academy school uniform", "black jacket", "plaid pants]", "skull (persona 5)", "leather jacket]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black vest", "cross-laced top", "ripped jeans", "black belt", "knee boots]", "black dress", "single side slit]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black dress", "gothic lolita", "black choker", "red back bow]", "marie rose (devilish servant against the splashing waves)", "blue one-piece swimsuit", "highleg one-piece swimsuit", "see-through clothes", "blue thighhighs", "detached sleeves", "black gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[blue jacket", "plaid skirt", "thigh socks", "red necktie", "single blue glove]", "honoka (summer angel on the shore) (doa) bikini", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[pink hoodie", "striped fingerless gloves", "green shorts]", "harp note (mega man)", "black bodysuit", "pink dress", "heart", "helmet", "striped sleeves", "pink gloves", "pink knee boots", "wrist cuffs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[white hoodie", "striped thighhighs", "wide sleeves", "hair ornament]", "adult neptune", "black hoodie", "thigh strap", "black choker]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black leotard", "black thighhighs", "wrist cuffs", "cleavage cutout", "long sleeves", "black gloves]", "purple heart (goddesses' promise)", "black dress", "single side slit", "halterneck", "black elbow gloves", "plunging neckline]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[blue hat", "blue dress", "pink bows", "fur-trimmed dress", "wide sleeves", "white pantyhose", "fur-trimmed boots", "blue knee boots]", "--white hair", "white sister rom", "blue hair", "white leotard", "pink trim", "white elbow gloves", "halterneck", "knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[pink hat", "pink dress", "blue bows", "fur-trimmed dress", "fur-trimmed boots", "pink boots", "white pantyhose]", "--brown hair", "white system ram", "white leotard", "pink trim", "white elbow gloves", "halterneck", "knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black jacket", "white shirt", "black necktie", "gauntlets", "skull belt", "black pantyhose", "white knee boots]", "kiseijou rei (goddess form)", "armored dress", "black leotard", "cleavage cutout", "black sleeves", "black gloves", "arm guards", "black leggings", "thigh cutouts", "shoulder pads]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[core crystal (xenoblade)", "red leotard", "black fingerless gloves", "shoulder pads", "tiara]", "pyra (pro swimmer) (xenoblade)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[mythra (massive melee) (xenoblade)", "core crystal (xenoblade)", "white dress", "detached sleeves", "halterneck", "thigh strap", "white elbow gloves]", "mythra (radiant beach) (xenoblade)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[yellow jumpsuit", "belt", "wide sleeves", "white cloak]", "nia (blade) (xenoblade)", "white leotard", "detached sleeves", "detached collar", "white thigh boots", "sleeves past wrists]", "nia (fancy sundress) (xenoblade)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black bodysuit", "black choker", "black jacket", "green trim", "multiple belts]", "bikini", "blue bikini", "green bikini", "two-tone bikini", "multi-strapped bikini bottom", "sarong", "thigh strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[military uniform", "military jacket", "hat", "single shlouder pad", "white gloves", "hip armor", "black pants", "cape", "armored knee boots]", "black one-piece swimsuit", "see-through clothing", "official alternate costume]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[poppi qtpi (xenoblade)", "robot joints", "black leotard", "detached sleeves", "black gloves", "red garter straps", "thighhighs", "thigh straps]", "poppi alpha (xenoblade)", "puffy shorts", "armor", "mechnical arms]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white tube top", "detached sleeves", "detached collar", "brown skirt", "multiple belts]", "mecha-fiora", "cyborg", "white armor", "robot joints", "white bodysuit", "mechanical wings]", "mecha-fiora (speed cowling)", "cyborg", "blue armor", "robot joints", "revealing clothes]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[see-through clothes", "purple dress", "detached sleeves", "blue gloves", "fire gloves", "thigh boots", "fire boots]", "brighid (water lily) (xenoblade)", "teal one-piece swimsuit", "cleavage cutout", "halterneck", "fire gloves", "floral print]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black shorts", "black sleeveless shirt", "robot joints", "steampunk", "high collar", "frilled gloves", "black knee boots]", "pandoria (beach date) (xenoblade)", "steampunk", "robot joints", "teal bikini", "bikini skirt", "frilled bikini", "side-tie bikini bottom]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black suit", "black jacket", "black vest", "red shirt", "black necktie", "black pants", "white gloves]", "white fingerless gloves", "bandaged hands", "shirtless male", "white pants]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket", "white sweater", "blue skirt", "pantyhose]", "amiya (newsgirl) (arknights)", "amiya (fresh fastener) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white jacket", "black capelet", "black shorts", "multiple belts", "pantyhose", "thigh strap]", "texas (willpower) (arknights)", "texas (winter messenger) (arknights)", "texas (ambience synesthesia) (arknights)", "texas the omertosa (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket", "high collar", "wide sleeves", "black shorts]", "lappland (refined horrormare) (arknights)", "lappland (ambience synesthesia) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[witch hat", "black capelet", "white shirt", "black pants", "cutouts]", "skadi (elite ii) (arknights)", "[skadi the corrupting heart (arknights)", "red dress", "aqua gloves", "brown ascot]", "skadi (waverider) (arknights)", "skadi (the next afternoon tea) (arknights)", "skadi the corrupting heart (sublimation) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white sleeveless shirt", "purple skirt", "white pantyhose", "thigh strap", "white cape", "two-sided cape]", "suzuran (spring praise) (arknights)", "suzuran (yukibare) (arknights)", "suzuran (lostlands flowering) (arknights)", "[suzuran (let's carnival!) (arknights)", "orange dress]", "suzuran (pajamas) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[green dress", "off-shoulder dress", "white cape", "choker]", "kal'tsit (remnants) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shirt", "white vest", "high collar", "black skirt", "pantyhose", "fingerless gloves]", "exusiai (city rider) (arknights)", "white jacket]", "exusiai (wild operation) (arknights)", "exusiai (midnight delivery) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket", "fingerless gloves", "white shirt", "cross-laced clothes", "black shorts", "navel", "knee boots", "orange necktie]", "ch'en (ageless afterglow) (arknights)", "ch'en (after storm) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[--red eyes", "--white hair", "--long hair", "white armor", "full armor", "pelvic curtain", "helmet", "shoulder pads", "bracers", "gauntlets", "leg armor", "shin guards]", "mudrock (elite ii) (arknights)", "white armor", "off shoulder", "black crop top", "bracers", "gauntlets", "leg armor", "shin guards]", "mudrock (silent night) (arknights)", "black bikini", "hair flower", "black sash]", "mudrock (obsidian) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket", "white shirt", "turtleneck", "black shorts", "fishnet pantyhose", "fingerless gloves", "black skirt", "two-sided skirt]", "w (wanted) (arknights)", "[w (fugue) (arknights)", "black cargo pants]", "w (cannot wait for) (arknights)", "yellow jacket]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket", "fur-trimmed jacket", "white gloves", "white shirt", "black shorts]", "mostima (spellbreaker) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white jacket", "black high-waist skirt", "straps]", "saria (the law) (arknights)", "saria (stronghold) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[nun", "habit", "black dress", "side slits", "pelvic curtain", "black thighhighs", "garter straps", "black jacket", "wide sleeves]", "specter the unchained (arknights)", "pirate hat", "black dress", "straps", "black pantyhose", "cutouts]", "specter (undercurrent) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[sleeveless white dress", "red necktie", "black jacket]", "dusk (everything is a miracle) (arknights)", "dusk (ambience synesthesia) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[red tube top", "white shorts", "belt", "white jacket", "red gloves]", "nian (unfettered freedom) (arknights)", "nian (thunderbolt director) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shirt", "black shorts", "white coat", "knee socks", "black gloves]", "angelina (summer flower) (arknights)", "angelina (distinguished visitor) (arknights)", "angelina (sports) (arknights)", "angelina (ambience synesthesia) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[white shirt", "black skirt", "pink coat", "lanyard", "white thighhighs", "garter straps]", "goldenglow (maiden for the bright night) (arknights)", "goldenglow (summer flowers) (arknights)", "goldenglow (party in the garden) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "two-tone skirt", "white capelet", "black gloves", "wide sleeves]", "irene (voyage of feathers) (arknights)", "irene (the adjudicatrix and her resolve) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[twintails", "blue hoodie", "black leggings", "black shorts", "white shirt", "black vest]", "blue poison (shoal beat) (arknights)", "blue poison (elite ii) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black scarf", "black crop top", "black shorts", "white jacket", "see-through jacket", "straps", "thigh pouch]", "schwarz (skyline) (arknights)", "schwarz (presents) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "white cloak", "wide sleeves", "red ribbons", "black thighhighs", "red garter straps]", "eyjafjalla (summer flower) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[blue shirt", "black skirt", "pantyhose", "white coat", "wide sleeves", "white gloves]", "sussurro (summer flower) (arknights)", "[sussurro (travel freely) (arknights)", "red coat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black jacket around waist", "black shirt", "black capri pants", "black armband", "high collar", "black gloves]", "hoshiguma (ronin huntress) (arknights)", "hoshiguma (seeker) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white shirt", "white pants", "black vest", "white jacket", "jacket on shoulders", "fingerless gloves]", "mountain (book reader) (arknights)", "mountain (dark cloud) (arknights)"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white tank top", "red shorts", "black leather jacket", "fur-trimmed jacket", "choker]", "siege (city destroyer) (arknights)", "siege (legacy) (arknights)", "siege (ambience synesthesia) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[glasses", "white dress", "white coat", "high collar", "wide sleeves", "asymmetrical legwear", "single thighhigh", "thigh strap]", "silence (frosted breath) (arknights)", "white coat", "white scarf", "black pantyhose", "wide sleeves", "feather trim", "big feathers]", "silence (lacquer) (arknights)", "yellow coat", "teal gloves", "black shorts", "see-through pants", "transparent pants", "knee pads]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[twintails", "white dress", "wide sleeves", "single kneehigh", "thigh straps", "black shirt]", "ifrit (sunburn) (arknights)", "waist apron", "see-through clothes", "transparent apron]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white tank top", "white coat", "black skirt", "single white thighhigh", "thigh strap", "multiple belts", "fingerless gloves]", "blaze (burst feline) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black coat", "white pants", "white shirt", "black gloves]", "chongyue (alighting) (arknights)"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "white jacket", "black thighhighs", "garter straps", "black gloves]", "virtuosa (diversity oneness) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[armored dress", "black dress", "white boobplate", "white shoulder pads", "white gauntlets", "black knee boots]", "nearl the radiant knight (arknights)", "cape]", "nearl (shimmering dew) (arknights)", "one-piece swimsuit", "eyewear on head", "see-through clothes", "swimsuit under clothes]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white dress", "hooded white coat", "wide sleeves", "pantyhose]", "ho'olheyak (carriage of the winds of time) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black skirt", "black vest", "white shirt", "black coat", "two-sided coat", "sheer thighhighs", "thigh strap", "thigh pouch", "black hat]", "swire the elegant wit (arknights)", "swire (honor and splendor) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black shirt", "black skirt", "multiple belts", "thighhighs", "cross-laced legwear", "white jacket", "wide sleeves]", "ceobe (unfettered) (arknights)", "ceobe (summer flowers) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black shirt", "black skirt", "white coat", "black thighhighs]", "utage (summer flowers) (arknights)", "sun hat", "eyewear on head", "pink-tinted eyewear]", "black shirt", "black jacket", "black plaid skirt", "yellow pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shirt", "black shorts", "black jacket", "black gloves", "single knee pad]", "jessica (iron block) (arknights)", "gas mask]", "jessica the liberated (arknights)", "tube top]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "white ascot", "black coat", "thighhighs", "single gauntlet", "single arm guard]", "penance (occasionally flushed) (arknights)", "[penance (ambience synesthesia) (arknights)", "leather jacket", "black cropped jacket", "fingerless gloves", "black mini skirt", "single side slit", "cross-laced clothes", "pantyhose", "torn pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[full armor", "boobplate", "shoulder pads", "fur-trimmed cloak", "gauntlets", "hip armor", "multiple belts", "greaves]", "blemishine (moon catastrborn) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white cableknit turtleneck", "white dress", "pelvic curtain", "side slit", "white thighhighs", "wide sleeves", "black cloak]", "pramanix (caster's frost) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black cape", "two-sided cape", "fingerless gloves", "white dress", "see-through clothes", "thigh straps]", "rosmontis (become anew) (arknights)", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white shorts", "white coat", "wide sleeves", "black thighhighs", "garter straps]", "platinum (shimmering dew) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white dress", "black coat", "two-sided coat", "two-tone gloves", "orange armband]", "ptilopsis (elite ii) (arknights)", "ptilopsis (serenity) (arknights)", "ptilopsis (amongst the clouds) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[fur-trimmed coat", "black coat", "black shorts", "thigh straps", "fingerless gloves]", "la pluma (summer flowers) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white shorts", "hooded white jacket", "blue shirt", "wristband]", "tequila (cardwinner) (arknights)"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white shirt", "black shorts", "long white coat", "yellow necktie", "black elbow gloves]", "ling (it does wash the strings) (arknights)", "two-tone dress]", "ling (towering is cliff of nostalgia) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[black kimono", "knee pads", "purple pants]", "saga (there they be) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[two-tone dress", "black pants", "hooded red coat", "fur-trimmed coat]", "projekt red (light breeze) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[green jacket", "black jacket", "black belt", "black skirt", "red skirt", "plaid skirt", "belt pouch", "thighhighs]", "bagpipe (queen no. 1) (arknights)", "[single braid", "blue overall skirt", "white skirt", "white collared shirt", "black belt]", "bagpipe (royal guardswoman) (arknights)", "black hat", "black gloves", "pantyhose", "thigh straps]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white shirt", "blue dress", "sleeve cuffs", "multiple belts]", "astesia (starseeker) (arknights)", "[astesia (frlibe on the palace) (arknights)", "high-waist dress", "detached sleeves", "thigh strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white cloak", "black shirt", "boobplate", "black shorts", "thighhighs", "pelvic curtain", "black hat]", "whislash (glory purple) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black coat", "white gloves", "pantyhose]", "magallan (elite ii) (arknights)", "brown ribbed sweater", "white coat around waist", "pantyhose", "single white glove]", "magallan (shaved-ice memories) (arknights)", "coat around waist", "blue pants]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[white leotard", "boobplate", "black dress", "sheer thighhighs", "torn thighhighs", "thigh pouch]", "gravel (modeling night) (arknights)", "black hat", "black gloves", "white cloak]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[grey high-waist skirt", "white tank top", "white coat", "wide sleeves", "multiple belts]", "myrtle (summer flowers) (arknights)", "myrtle (light gold celebration) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white coat", "black sleeves", "wide sleeves", "black china dress", "patterned clothing", "thigh strap]", "feater (dojo star) (arknights)", "black crop top", "black pants", "yellow jacket", "jacket around waist]", "feater (gourmet) (arknights)", "white pants", "white crop top", "red cropped jacket", "red-tinted eyewear]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[sleeveless black dress", "high collar dress", "detached sleeves", "black gloves]", "gavial the invincible (arknights)", "dreadlocks", "green crop top", "green shorts", "kneehighs", "detached sleeves", "torn clothes]", "gavial the invincible (holiday) (arknights)", "blue bikini", "white shorts", "white jacket", "blue sleeves", "open fly", "white hat]", "gavial (combat medic) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black hairband", "black crop top", "white cropped coat", "hooded coat", "breast curtains", "grey shorts", "blue pants", "thigh cutouts", "belt pouch]", "aurora (elite ii) (arknights)", "black tank top", "white cropped jacket", "hooded jacket", "grey shorts", "belt pouch", "knee pads", "black gloves]", "aurora (polar catcher) (arknights)", "orange shirt", "orange shorts", "black pants", "pantyhose", "black coat", "black knee pads]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black shirt", "black skirt", "thighhighs", "blue coat]", "liskarm (overload) (arknights)", "black pantyhose", "black shirt", "black skirt", "bulletproof vest]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "thighhighs", "criss-cross garter straps", "white coat", "red armband", "two-sided coat]", "reed the flame shadow (arknights)", "white dress", "long cape", "floral print pantyhose", "see-through sleeves", "transparent sleeves", "thigh straps]", "reed the flame shadow (arknights)", "reed the flame shadow (curator) (arknights)", "witch hat", "white dress", "pantyhose", "horns through headwear", "black necktie", "black jacket]", "reed the flame shadow (arknights)", "reed the flame shadow (summer flowers) (arknights)", "mismatched bikini", "black multi-strapped bikini bottom", "blue bikini top", "swimsuit cover-up", "see-through shirt", "thigh straps]", "reed (emerald holiday) (arknights)", "white dress", "green strap", "thigh straps", "yellow shirt", "black cape", "two-sided cape]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[white bodysuit", "black shirt", "white ascot", "black coat", "black thigh boots", "black hat]", "gladiia (return) (arknights)", "gladiia (i am the tides) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "frilled dress", "white shirt", "wide sleeves", "black gloves", "white thighhighs]", "sora (summer flowers) (arknights)", "white bikini", "white skirt", "black belt", "white cropped jacket", "red bow]", "sora (melodiosa) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[blue sailor dress", "black jacket", "wide sleeves", "sleeves past wrists", "red pantyhose]", "gummy (summer flowers) (arknights)", "white dress", "see-through dress", "blue bikini skirt", "blue hat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "black hooded jacket", "goggles around neck", "flower", "grey partially fingerless gloves", "pelvic curtain", "black thighhighs", "torn clothes", "black boots]", "tomimi (silent night) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[red coat", "black shirt", "red skirt", "pantyhose", "kneepads", "detached collar", "headphones]", "frostleaf (breaking the ice) (arknights)", "purple pants", "purple scarf", "cropped black jacket", "ears through headwear]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[yellow dress", "black tube top", "single-shoulder dress", "thigh pouch", "black gloves", "eyewear on head]", "eunectes (forgemaster) (arknights)"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    },
    {
        ...
        enhancers: ["[black dress", "orange armband", "pantyhose", "thigh straps", "wide sleeves]", "talulah the fighter (arknights)", "single knee pad", "thigh strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Video Games"
    ...
    },
    {
        ...
        enhancers: ["[nun", "habit", "pink-tinted eyewear", "black dress]", "green miniskirt", "pink tank top", "crop top", "white belt", "pink-tinted eyewear]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[glasses", "orange vest", "jeans", "horizontal-striped shirt", "two-tone shirt]", "black crop top", "black skirt", "black sclera", "white belt", "black elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[domino high school uniform", "pink jacket", "blue bowtie", "blue skirt", "black thighhighs]", "sleeveless teal shirt", "blue shorts", "white belt", "multiple bracelets", "white thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[domino high school uniform", "blue jacket", "blue pants]", "green jacket", "high collar", "two-tone shirt", "single fingerless glove", "jeans]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[black tank top", "red skirt", "blue pants", "multiple belts", "belt pouch]", "aqua dress", "white cropped jacket", "black pantyhose", "white knee boots", "cross-laced footwear]", "orange sweater", "blue pleated skirt", "off-shoulder", "black leotard", "yellow pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[kaname madoka (magical girl)", "frilled dress", "magical girl]", "mitakihara school uniform", "plaid skirt", "white shirt", "long sleeves", "white thighhighs]", "ultimate madoka"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[akemi homura (magical girl)", "collared capelet", "magical girl]", "mitakihara school uniform", "plaid skirt", "white shirt", "long sleeves", "white thighhighs]", "akuma homura", "feathered wings", "black dress", "elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[miki sayaka (magical girl)", "cape", "armored dress]", "mitakihara school uniform", "plaid skirt", "white shirt", "long sleeves", "black knee socks]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tomoe mami (magical girl)", "puffy short sleeves", "detached sleeves", "corset]", "mitakihara school uniform", "plaid skirt", "white shirt", "long sleeves", "red ribbon", "pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[mitakihara school uniform", "plaid skirt", "black pantyhose", "white shirt]", "black dress", "feather-trimmed dress", "wings", "patterned thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[mitakihara school uniform", "plaid skirt", "white shirt", "long sleeves", "black knee socks]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[black dress", "choker", "wrist cuffs", "red shirt", "see-through shirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[single horn", "white tunic", "white pants", "wide sleeves", "green belt]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[sailor star maker", "circlet", "black shorts", "black elbow gloves", "black bikini top", "black knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: "true",
        mediaType: "Shows or Movies"
    },
    ...
    },
    {
        ...
        enhancers: ["[arabian clothes", "white harem pants", "thigh cutout", "brown bandeau", "bracers]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[sleeveless leotard", "blue leotard", "orange skirt", "detached collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[blue choker", "blue leotard", "blue thigh boots", "blue elbow gloves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[cafe mew mew uniform", "maid", "frilled red dress", "apron", "maid headdress", "pink ribbon]", "mew ichigo", "cat girl", "animal ear fluff", "cat ears", "cat tail", "pink dress", "puffy detached sleeves]", "school uniform", "neck bell", "grey skirt", "grey jacket", "red ribbon", "black sailor collar]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[cafe mew mew uniform", "double bun", "maid", "frilled blue dress", "apron", "maid headdress", "blue ribbon", "blue socks", "bare hands]", "mew mint", "bird girl", "blue wings", "blue parrot tail", "puffy detached sleeves", "dress]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[cafe mew mew uniform", "maid", "frilled purple dress", "apron", "maid headdress", "pink ribbon", "pink socks", "bare hands]", "mew zakuro", "wolf girl", "wolf ears", "wolf tail", "purple crop top", "puffy detached sleeves", "purple thigh boots", "purple shorts]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[cafe mew mew uniform", "round eyewear", "maid", "frilled green dress", "apron", "maid headdress", "green ribbon", "green socks", "bare hands]", "mew lettuce", "antennae", "green leotard", "choker", "single hair tube]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[cafe mew mew uniform", "maid", "frilled orange dress", "apron", "maid headdress", "yellow ribbon", "yellow socks", "bare hands]", "mew pudding", "monkey girl", "monkey tail", "monkey ears", "detached puffy sleeves", "yellow jumper]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[tomoeda elementary school uniform", "white hat", "white pleated skirt", "black shirt]", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tomoeda elementary school uniform", "black pants", "black shirt", "sweater around neck]", "green hat", "chinese clothes", "magical boy]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[tomoeda high school uniform", "blue jacket", "white shirt", "black necktie", "blue pants]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tomoeda elementary school uniform", "white pleated skirt", "black shirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[blue coat", "fur-trimmed coat", "black pants", "fur-trimmed boots]", "black shirt", "black pants", "black vest", "black jacket]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[two-tone crop top", "black bikini", "bikini bottom only", "long sleeves", "single thighhigh", "striped thighhigh", "thigh strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[purple suit", "purple pants", "purple suit jacket", "green collared shirt", "cleavage]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[layered dress", "black dress", "pleated dress", "white dress", "red dress", "brown elbow gloves", "boobplate", "metal wrist cuffs", "single pauldron", "red ribbon", "thigh boots", "zettai ryouiki]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[armor", "chestplate", "green cape", "fur trim", "fingerless gloves", "green pants", "multiple belts", "hip armor", "knee boots]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white dress", "layered dress", "blue dress", "frilled dress", "blue ribbon", "white pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[armor", "boobplate", "purple dress", "detached collar", "black thighhighs", "detached sleeves", "black sleeves", "wrist guards", "black belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black dress", "gothic lolita", "red necktie", "puffy short sleeves", "black thighhighs", "garter straps]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[green dress", "two-tone tabard", "yellow cape", "blue ribbon", "wide sleeves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[jeans", "capri pants", "white crop top", "red neckerchief", "brown gloves", "brown belt]", "green dress", "red neckerchief", "brown arm bands", "detached sleeves", "wide sleeves", "green thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["yellow dress", "[tokyo-3 middle school uniform", "blue dress", "white shirt", "red ribbon]", "white shirt", "denim shorts]", "red bodysuit", "mecha pilot suit]", "red bodysuit", "mecha pilot suit", "eyepatch]", "white bodysuit", "mecha pilot suit", "eyepatch]", "striped bikini"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tokyo-3 middle school uniform", "blue dress", "white shirt", "red ribbon]", "white bodysuit", "mecha pilot suit]", "white bodysuit", "mecha pilot suit", "very long hair]", "black bodysuit"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tokyo-3 middle school uniform", "black pants", "white shirt", "wristwatch]", "mecha pilot suit", "blue bodysuit", "chestplate]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[tokyo-3 middle school uniform", "black pants", "white shirt]", "mech pilot suit", "black bodysuit]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[plaid skirt", "white shirt", "green necktie]", "mecha pilot suit", "pink bodysuit", "chest jewel]",
    ...
    },
    {
        ...
        enhancers: ["[black jacket", "black pants", "white gloves", "red turtleneck]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[sleeveless blue shirt", "front zipper", "black skirt", "red pantyhose", "white lab coat]", "leeveless blue shirt", "front zipper", "black skirt", "pantyhose]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[tokyo-3 middle school uniform", "blue dress", "white shirt", "red ribbon]", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[long white shirt", "angel (evangelion)", "angel wings", "multiple wings", "{{six wings}}]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[pink shirt", "blue high-waist skirt", "long skirt", "white lab coat]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[sleeveless red dress", "detached sleeves", "fingerless elbow gloves", "black leggings", "leg cutout", "multiple belts]", ],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[--black hair", "--short hair", "faceless", "black cape", "helmet]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[bikini top only", "pink collar", "black short shorts", "pink thighhighs", "white boots]", "space yoko", "white cape", "black bikini", "star (symbol)", "white thigh boots]", "yomako", "long brown skirt", "single side slit", "pink shirt", "white cropped jacket", "green necktie", "glasses]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[pink dress","red necktie","gold belt","gold armbands]", "[antispiral nia","black bodysuit","neon trim]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue jacket","sarashi","brown shorts","red armband","goggles on head]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[sarashi", "red cape", "brown pants", "red-tinted eyewear", "triangular eyewear]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[black bike shorts","black tanktop","yellow gloves","black armband]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[military uniform","military hat","pantyhose","single orange armband]", "[sleeveless black bodysuit","black shorts","multiple white belts","gloves","black armbands]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[eyepatch","off-shoulder dress","red dress","wide sleeves","thigh strap","knee strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black skirt","black crop top","yellow gloves","white belt","black knee boots","black armbands]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[ boobies uniform","choker", "hairband", "pink bikini", "wrist cuffs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[blue highleg leotard","white croped vest","white skirt","hip vent","white thigh boots","single fingerless glove","red glove","impossible clothes]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white highleg leotard","red cropped vest","red shorts","impossible clothes]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[magical girl", "blue dress", "pleated skirt","sailor collar", "red armband]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[magical girl","black knee boots","purple leotard","white dress","cleavage cutout","arm guards]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[magical girl","white one-piece swimsuit","demon wings","headband","goggles around neck","black fingerless gloves","frilled thigh strap]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[pink vest","front zipper","white bikini bottom","white thigh boots","head ornament]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[school uniform","green pleated skirt","white shirt","green sailor collar","yellow ribbon]", "[magical girl","magia baiser","white dress","revealing clothes","purple pants","bat wings","low wings","yellow horns]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[school uniform","green pleated skirt","white shirt","green sailor collar","yellow ribbon", "oversized yellow jacket", "sleeves past wrists]", "[magical girl","leoparde (mahou shoujo ni akogarete)","military jacket","military hat","black panties","green gloves","thigh boots","garter belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[school uniform","green pleated skirt","white shirt","green sailor collar","yellow ribbon]", "[magical girl","magia azure","frilled blue dress","white shirt","center frill","blue elbow gloves","blue thigh boots]", "[magical girl", "magia azure (la verita)", "blue skirt", "hakama", "hakama skirt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[school uniform","green pleated skirt","white shirt","green sailor collar","yellow ribbon]","[magical girl","magia magenta","frilled pink dress","white shirt","center frill","pink elbow gloves","pink thigh boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue dress", "white shirt", "white hat", "belt]", "[magical girl","nero alice","blue dress","apron","forehead mark","black hair bow","large hair bow","pink ribbon]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[school uniform", "blue jacket", "grey skirt", "thighhighs", "red ribbon", "white shirt]", "[magical girl","loco musica","white hat","white coat","aqua dress","black bikini top only","sailor collar","black thighhighs","aqua knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[school uniform","green pleated skirt","white shirt","green sailor collar","yellow ribbon]", "[magical girl","magia sulfur","frilled yellow dress","white shirt","center frill","yellow elbow gloves","yellow thigh boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[open blue cardigan", "oversized cardigan", "white shirt", "grey skirt]", "[magical girl","leberblume","gradient hair","aqua dress","pelvic curtain","side slits","aqua elbow gloves","high collar","aqua thigh boots","hood up]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[purple fur-trimmed coat","revealing clothes","no bra","purple thigh boots","purple short shorts]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[green dress","metal collar","white elbow gloves","white thigh boots","belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[purple skirt","black shorts","metal collar","purple sleeves","wrist cuffs","greaves]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[armor","boobplate","blue skirt","white shirt","see-through clothes","greaves","arm guards]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[white skirt", "white thighhighs", "blue bowtie", "garter straps", "red jacket]", "[red bikini", "frilled bikini]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[maid","black dress","center frills","detached sleeves","wrist cuffs","brown knee boots]", "[black bikini", "eyewear on head]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[shinda sekai sensen uniform", "red shirt", "shirt under shirt]"],
        defaultGender: "boy",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[shinda sekai sensen uniform", "white thighhighs", "single thigh belt]", "[black jacket", "yellow turtleneck", "fur-trimmed shorts]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[green striped jacket", "brown skirt", "pantyhose]", "b[lack and white striped jacket", "blue pleated skirt", "knee socks]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[halterneck", "red hair bow", "pink dress", "black corset", "white thighhighs]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[white shirt", " red hair bow", "striped sleeves", "blue pleated skirt", "belt]", "[red dress","red hair bow","choker","black fingerless gloves","cropped pink vest","white belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[blue shirt", "hairclip", "blue necktie", "plaid skirt", "white belt]", "[blue dress","choker","cropped blue vest","black fingerless gloves","white belt]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[green hat","yellow turtleneck","short sleeves","green shorts","orange wristband]", "[green dress","cropped yellow vest","black fingerless gloves","choker]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[black hairband", "sleeveless dress", "pink collared dress", "flower print]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    },
    {
        ...
        enhancers: ["[green jacket","black skirt","white crop top]", "[updo","black tube dress","gold hoop earrings","black choker","multiple bracelets]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
    ...
    },
    {
        ...
        enhancers: ["[pink hairband","pink turtleneck sweater","ribbed sweater","short sleeves","white skirt","white knee boots]"],
        defaultGender: "girl",
        genderswapAvailable: true,
        ageUpAvailable: true,
        mediaType: "Shows or Movies"
