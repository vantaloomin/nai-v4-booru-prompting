document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('generate-btn').addEventListener('click', function() {
      ...
      // Display the generated prompt as plain text inside the output-preview div.
    ...
    // Since the "Expand" button is now placed outside of the prompt box,
    // we query it separately along with the output container.
    const toggleBtn = document.getElementById("toggle-expand");
    const outputContainer = document.getElementById("output-container");
  
    // Set up the toggle button to expand/collapse the prompt preview container.
    toggleBtn.addEventListener("click", function() {
      // Toggle the "expanded" class on the output container.
      outputContainer.classList.toggle("expanded");
      // Update the button text based on whether the container is expanded.
